...
class TimeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerTime = channel.unary_unary(
                '/timesync.TimeService/GetServerTime',
...
def add_TimeServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'timesync.TimeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('timesync.TimeService', rpc_method_handlers)
